...
// trim permet de voir si un champ contient quelque chose
  function addTodo(){
    if (input.trim() == "") {
      return
    }
    ...
    setTodos(newTodos)
    // pour renitialiser input
    setInput("")
    // remettre select a Moyenne
    setPriority("Moyenne")
...
const mediumtCount = todos.filter((t) => t.Priority === "Moyenne").length
